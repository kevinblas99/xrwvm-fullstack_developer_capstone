...
def initiate():
    ...
    car_model_data = [
      ...
      {"name":"XTRAIL", "type":"SUV", "year": 2024, "car_make":car_make_instances[0]},
      {"name":"A-Class", "type":"SUV", "year": 2024, "car_make":car_make_instances[1]},
      {"name":"C-Class", "type":"SUV", "year": 2024, "car_make":car_make_instances[1]},
      {"name":"E-Class", "type":"SUV", "year": 2024, "car_make":car_make_instances[1]},
      {"name":"A4", "type":"SUV", "year": 2024, "car_make":car_make_instances[2]},
      {"name":"A5", "type":"SUV", "year": 2024, "car_make":car_make_instances[2]},
      {"name":"A6", "type":"SUV", "year": 2024, "car_make":car_make_instances[2]},
      {"name":"Sorrento", "type":"SUV", "year": 2024, "car_make":car_make_instances[3]},
      {"name":"Carnival", "type":"SUV", "year": 2024, "car_make":car_make_instances[3]},
      {"name":"Cerato", "type":"Sedan", "year": 2024, "car_make":car_make_instances[3]},
