...
const SearchCars = () => {
  ...
  return (
    ...
    <div style={{ 
      ...
      <div>
        <label style={{ marginRight: '10px', fontSize: '1.1rem' }}>Make</label>
        <select style={dropdownStyle} name="make" id="make" onChange={SearchCarsByMake}>
          {makes.length === 0 ? (
      ...
      <div>
        <label style={{ marginRight: '10px', fontSize: '1.1rem' }}>Model</label>
        <select style={dropdownStyle} name="model" id="model" onChange={SearchCarsByModel}>
          {models.length === 0 ? (
            <option value=''>No data found</option>
          ) : (
            <>
      ...
      <div>
        <label style={{ marginRight: '10px', fontSize: '1.1rem' }}>Year</label>
        <select style={dropdownStyle} name="year" id="year" onChange={SearchCarsByYear}>
      ...
      <div>
        <label style={{ marginRight: '10px', fontSize: '1.1rem' }}>Mileage</label>
        <select style={dropdownStyle} name="mileage" id="mileage" onChange={SearchCarsByMileage}>
          <option selected value='all'> -- All -- </option>
      ...
      <div>
        <label style={{ marginRight: '10px', fontSize: '1.1rem' }}>Price</label>
        <select style={dropdownStyle} name="price" id="price" onChange={SearchCarsByPrice}>
          <option selected value='all'> -- All -- </option>
    ...
    <div style={{ margin: '20px', textAlign: 'center' }}>
      {cars.length === 0 ? (
        <p style={{ fontSize: '1.2rem', color: '#999' }}>{message}</p>
      ) : (
        <div>
          <hr/>
          {cars.map((car) => (
            <div key={car._id} style={carCardStyle}>
              <h3 style={{ fontSize: '1.5rem', color: '#333' }}>{car.make} {car.model}</h3>
              <p>Year: {car.year}</p>
